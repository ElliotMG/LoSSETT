...
# Main job spec
#SBATCH --array=[1-30]                          # job array (item identifier is %a)
...
#SBATCH --mem-per-cpu=100G                       # memory per cpu (should end up as memory per task)

# Output & monitoring
#SBATCH --job-name="calc_DR_kscale_native_serial_00Z"         # job name
#SBATCH --output=/home/users/dship/log/log_calc_DR_indicator_kscale_native_serial_00Z_%a.out      # output file
#SBATCH --error=/home/users/dship/log/log_calc_DR_indicator_kscale_native_serial_00Z_%a.err       # error file
