...
#SBATCH --array=[11-20]                             # job array (item identifier is %a)
...
#SBATCH --output=/home/users/dship/log/log_calc_DR_indicator_kscale_native_12_%a.out      # output file
#SBATCH --error=/home/users/dship/log/log_calc_DR_indicator_kscale_native_12_%a.err       # error file
#SBATCH
...
python3 -m LoSSETT.control.run_lossett_kscale_native "DYAMOND3" "n2560RAL3" "none" 2020 9 ${SLURM_ARRAY_TASK_ID} "12" ${max_r_deg}
